...
local library = loadstring(game:HttpGet("https://pastebin.com/UtCsNdP3"))()
local venyx = library.new("Bitchdick | sxgxvx")

-- themes
local themes = {
Background = Color3.fromRGB(255, 170, 0),
Glow = Color3.fromRGB(255, 170, 0),
...
--Two page
local page2 = venyx:addPage("Autofarm")
...
--Warmode Page
local warmodepage = venyx:addPage("War Farm")
...
--Three page
local page3 = venyx:addPage("Quests Maker")
...
local inf = venyx:addPage("Inf Spin")
